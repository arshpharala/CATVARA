...
@section('content')
  ...
  <form action="{{ route('companies.update', $company->id) }}" method="POST" class="ajax-form" enctype="multipart/form-data">
    @csrf
    @method('PUT')
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select name="company_status_id"
                          class="form-control @error('company_status_id') is-invalid @enderror">
                  ...
                  @error('company_status_id') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  @error('invoice_postfix') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  @error('quote_postfix') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <textarea name="address" rows="3"
                        class="form-control @error('address') is-invalid @enderror">{{ old('address', $company->detail?->address) }}</textarea>
      ...
      <div class="col-lg-4">
        <div class="card card-outline card-secondary">
          ...
          <div class="card-body">
            ...
            @php
              $logoSrc = $company->logo ? asset('storage/'.$company->logo) : asset('theme/adminlte/dist/img/AdminLTELogo.png');
            @endphp
