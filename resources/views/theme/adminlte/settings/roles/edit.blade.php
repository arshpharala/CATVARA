...
<div class="container-fluid">
  <div class="row mb-3 align-items-center">
    <div class="col-sm-6">
      <h1 class="m-0 font-weight-bold text-dark">Edit Role</h1>
...
@section('content')
<div class="container-fluid">
  <form action="{{ route('company.settings.roles.update', ['company' => $company->uuid, 'role' => $role->id]) }}" method="POST" id="roleForm">
    @csrf
    @method('PUT')
