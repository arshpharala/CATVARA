...
@section('content-header')
  <div class="container-fluid">
    <div class="row mb-4 align-items-center">
      <div class="col-sm-6">
        <h1 class="m-0 font-weight-bold text-dark">Modules</h1>
        <p class="text-muted small mb-0">Manage master modules used to group permissions.</p>
      </div>
      <div class="col-sm-6 text-right">
        <a href="{{ route('modules.create') }}" class="btn btn-primary px-4 shadow-sm">
      ...
      <div class="card-header bg-white border-bottom py-3">
        <div class="d-flex justify-content-between align-items-center">
          <h3 class="card-title font-weight-bold mb-0">
            <i class="fas fa-layer-group mr-2 text-primary"></i> Module Directory
          </h3>
